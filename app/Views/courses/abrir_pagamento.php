...
<div style="max-width:640px; margin:0 auto; padding:16px 8px; text-align:center;">
    ...
    <a href="<?= htmlspecialchars($redirectUrl) ?>" target="_blank" rel="noopener noreferrer" style="
        ...
        padding:8px 18px; border-radius:999px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>;
        color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-size:13px; font-weight:600; text-decoration:none; margin-bottom:10px;">
        Abrir pagamento
    </a>
