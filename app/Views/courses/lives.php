...
<div style="max-width: 960px; margin: 0 auto; padding: 12px 8px 20px 8px;">
    <div style="margin-bottom:10px;">
        <a href="<?= CourseController::buildCourseUrl($course) ?>#lives" style="color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; font-size:12px; text-decoration:none;">&larr; Voltar para o curso</a>
    </div>
