...
<div style="max-width: 420px; margin: 0 auto;">
    ...
    <?php if (!empty($error)): ?>
        <div style="background: #3b1a1a; border-radius: 10px; padding: 10px 12px; color: #ffb3b3; font-size: 13px; margin-bottom: 14px; border: 1px solid <?= \App\Helpers\ThemeHelper::getSecondary() ?>;">
