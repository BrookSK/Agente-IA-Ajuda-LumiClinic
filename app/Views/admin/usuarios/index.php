...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    <form method="get" action="/admin/usuarios" style="margin-bottom: 14px; display:flex; gap:8px;">
        ...
        <button type="submit" style="border:none; border-radius:999px; padding:6px 12px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-size:13px; font-weight:600; cursor:pointer;">Buscar</button>
    </form>
