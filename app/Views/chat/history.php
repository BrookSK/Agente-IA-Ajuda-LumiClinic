...
<div style="max-width: 880px; margin: 0 auto;">
    ...
    <form method="get" action="/historico" style="margin-bottom: 14px; display:flex; gap:8px; flex-wrap:wrap;">
        ...
        <button type="submit" style="border:none; border-radius:999px; padding:8px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:600; font-size:13px; cursor:pointer;">
            Buscar
        </button>
    </form>
