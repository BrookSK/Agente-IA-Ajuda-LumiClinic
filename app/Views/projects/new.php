...
<div style="max-width: 620px; margin: 0 auto;">
    ...
    <form action="/projetos/criar" method="post" style="display:flex; flex-direction:column; gap:10px;">
        ...
        <div style="display:flex; justify-content:flex-end; gap:10px;">
            ...
            <button type="submit" style="border:none; border-radius:999px; padding:9px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:600; font-size:13px; cursor:pointer;">Criar projeto</button>
        </div>
    </form>
</div>
