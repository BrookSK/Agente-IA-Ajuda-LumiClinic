...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background:#111118; border-radius:14px; padding:14px; border:1px solid #272727; display:flex; flex-direction:column; gap:10px;">
        <div>
            ...
            <a href="https://wa.me/<?= htmlspecialchars($supportWhatsapp, ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener noreferrer" style="color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration:none; font-size:14px;">
                <?= htmlspecialchars($whatsLabel, ENT_QUOTES, 'UTF-8') ?>
            </a>
        </div>
        <div>
            <strong style="font-size:14px;">E-mail</strong><br>
            <a href="mailto:<?= htmlspecialchars($supportEmail, ENT_QUOTES, 'UTF-8') ?>" style="color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration:none; font-size:14px;">
