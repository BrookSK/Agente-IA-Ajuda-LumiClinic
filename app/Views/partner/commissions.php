...
<div style="max-width: 1100px; margin: 0 auto;">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; gap:12px; flex-wrap:wrap; margin-bottom:12px;">
        ...
        <form method="get" action="/parceiro/comissoes" style="display:flex; gap:8px; align-items:flex-end; flex-wrap:wrap;">
            ...
            <button type="submit" style="border:none; border-radius:999px; padding:8px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:800; cursor:pointer;">Filtrar</button>
        </form>
    </div>
        ...
        <div style="flex:1 1 420px; min-width:280px;">
            ...
            <div style="background:var(--surface-card); border-radius:14px; border:1px solid var(--border-subtle); padding:12px 12px;">
                <form method="post" action="/parceiro/comissoes/salvar-dados" style="display:flex; flex-direction:column; gap:10px;">
                    ...
                    <button type="submit" style="border:none; border-radius:999px; padding:9px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:900; cursor:pointer;">Salvar dados</button>
