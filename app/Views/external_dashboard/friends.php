                ...
                <?php foreach ($friends as $f): ?>
                    ...
                    <div class="friend-card-item">
                        ...
                        <div class="friend-avatar-wrap">
                            ...
                            <?php else: ?>
                                <div style="width: 68px; height: 68px; border-radius: 50%; background: radial-gradient(circle at 30% 20%, #fff 0, #64B5F6 25%, #2196F3 65%, #050509 100%); display: flex; align-items: center; justify-content: center; font-size: 28px; font-weight: 700; color: #050509; border: 3px solid var(--surface-card); box-shadow: 0 2px 8px rgba(0,0,0,.10);">
            ...
            <div class="pending-list">
                <?php foreach ($pending as $p): ?>
                    ...
                    <div class="pending-item">
                        ...
                        <?php else: ?>
                            <div style="width: 44px; height: 44px; border-radius: 50%; background: radial-gradient(circle at 30% 20%, #fff 0, #64B5F6 25%, #2196F3 65%, #050509 100%); display: flex; align-items: center; justify-content: center; font-size: 18px; font-weight: 700; color: #050509; flex-shrink: 0; border: 2.5px solid var(--surface-card);">
                                <?= htmlspecialchars($initial, ENT_QUOTES, 'UTF-8') ?>
                            </div>
                        <?php endif; ?>
