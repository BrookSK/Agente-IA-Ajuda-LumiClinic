        ...
        <div class="edit-form-section">
            ...
            <div class="edit-avatar-section">
                <div class="edit-avatar-preview">
                    ...
                    <?php else: ?>
                        <div style="width:80px; height:80px; border-radius:50%; background:radial-gradient(circle at 30% 20%, #fff 0, #64B5F6 25%, #2196F3 65%, #050509 100%); display:flex; align-items:center; justify-content:center; font-size:32px; font-weight:700; color:#050509; border: 3px solid var(--surface-card); box-shadow: 0 2px 10px rgba(0,0,0,.12);">
