        ...
        <div style="background:#111118; border-radius:16px; padding:14px; border:1px solid #272727;">
            ...
            <div style="margin-bottom:12px; display:flex; gap:8px; flex-wrap:wrap; align-items:center;">
                <form action="/conta/refazer-tour" method="post" style="margin:0;">
                    <button id="tuq-refazer-tour" type="submit" style="border:none; border-radius:999px; padding:8px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:650; cursor:pointer; font-size:13px;">
                        Refazer tour
                    </button>
                </form>
            ...
            <form action="/conta" method="post" style="display:flex; flex-direction:column; gap:10px;">
                ...
                <?php if (!empty($plan['allow_personalities'])): ?>
                    <div style="font-size:11px; color:#8d8d8d; margin-top:6px;">
                        ...
                        <a href="/conta/personalidade" style="color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration:none;">configurar personalidade do <?= htmlspecialchars(\App\Models\Branding::mascotName()) ?></a>.
                    </div>
                <?php endif; ?>
                <div style="font-size:12px; color:#b0b0b0;">
                    ...
                    <?php else: ?>
                        ...
                        <a href="/verificar-email" style="margin-left:6px; color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration:none;">Verificar agora</a>
                    <?php endif; ?>
                </div>
                <div>
                ...
                <?php endif; ?>
                <button type="submit" style="margin-top:6px; align-self:flex-start; border:none; border-radius:999px; padding:8px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-weight:600; cursor:pointer; font-size:13px;">
                    Salvar dados
                </button>
            </form>
        </div>
    ...
    <div style="display:flex; flex-direction:column; gap:12px;">
        <div style="background:#111118; border-radius:16px; padding:14px; border:1px solid #272727;">
            ...
            <?php if ($hasPaidActivePlan): ?>
                <div style="margin-top:8px;">
                    <a href="/tokens/comprar" style="font-size:12px; color:<?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration:none;">Comprar mais tokens extras</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div style="background:#111118; border-radius:16px; padding:14px; border:1px solid #272727;">
            ...
            <?php else: ?>
                ...
                <a href="/planos" style="display:inline-flex; margin-top:8px; border-radius:999px; padding:8px 14px; background:<?= \App\Helpers\ThemeHelper::getButtonGradient() ?>; color:<?= \App\Helpers\ThemeHelper::getBackground() ?>; font-size:13px; font-weight:600; text-decoration:none;">
...
<div style="max-width: 900px; margin: 16px auto 0 auto; font-size: 12px; color: #8d8d8d; text-align: right;">
    ...
    <a href="/suporte" style="color: <?= \App\Helpers\ThemeHelper::getSecondary() ?>; text-decoration: none;">Fale com o suporte</a>.
</div>
